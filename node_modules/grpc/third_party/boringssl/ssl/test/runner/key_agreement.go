...
type ecdhCurve interface {
	...
	computeSecret(peerKey []byte) (preMainSecret []byte, err error)
}
...
func (e *ellipticECDHCurve) computeSecret(peerKey []byte) (preMainSecret []byte, err error) {
...
func (e *x25519ECDHCurve) computeSecret(peerKey []byte) (preMainSecret []byte, err error) {
	if len(peerKey) != 32 {
		return nil, errors.New("tls: invalid peer key")
	}
...
func (ka *ecdheKeyAgreement) generateClientKeyExchange(config *Config, clientHello *clientHelloMsg, cert *x509.Certificate) ([]byte, *clientKeyExchangeMsg, error) {
	...
	preMainSecret, err := ka.curve.computeSecret(ka.peerKey)
	if err != nil {
		return nil, nil, err
	}
